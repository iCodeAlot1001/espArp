...
<body>
    ...
    <main>
        ...
        <input type="text" name="targetPass" id="routerIP" placeholder="Enter Password (optional)">
        ...
        <br>
        <br>
        <a href="/monitorMode" class="button">Go to Monitor</a>
        <br>
